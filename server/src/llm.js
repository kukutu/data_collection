...
export function buildTaskParserPrompt({ taskText, apps }) {
  return [
    ...
    '允许的 intent: launch_app, watch_feed, watch_live, live_entry, play_tencent_video, play_generic_media, amap_navigation, wechat_channels_feed, doubao_chat, ai_chat, back, home, missing_parameter, unsupported_flow, unknown。',
    ...
    'For doubao_chat and ai_chat, if the user does not specify an interval, set intervalMs to 8000. If the user specifies an interval below 3000, set intervalMs to 3000.',
